...
## Архитекткура проекта

Для реализациии данного проекта выбрана архитектура MVP. MVP — это паттерн программирования графических интерфейсов. В нём приложение делится на три компонента:
...
Это родительский класс для всех классов слоя View в приложении.
